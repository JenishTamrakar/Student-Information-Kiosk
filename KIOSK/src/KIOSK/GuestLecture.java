 ...
 */
public class GuestLecture extends javax.swing.JFrame {

    /**
     * Creates new form GuestLecture
     */
    public GuestLecture() {
        initComponents();
        showDate();
    ...
    void showTable(){
            ...
            ResultSet rs = stmt.executeQuery("select EVENT_NAME, EVENT_DATE from EVENT_DETAILS where EVENT_CATEGORY='Guest Lecture' and EVENT_STATUS='Open'");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Guest Lectures");

        jLabel8.setText("Click on the event to see the details about the event and to book your seat for the event.");
...
//                if((labEventName.getText()).equals(eventname) && (labName.getText()).equals(bookedby))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuestLecture.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GuestLecture().setVisible(true);
            }
        });
    }
