 ...
 */
public class CultureEvents extends javax.swing.JFrame {

    /**
     * Creates new form CultureEvents
     */
    public CultureEvents() {
        initComponents();
        showDate();
        showTime();
        showTable();
    ...
    void showTable(){
            ...
            ResultSet rs = stmt.executeQuery("select EVENT_NAME, EVENT_DATE from EVENT_DETAILS where EVENT_CATEGORY='Cultural Event' and EVENT_STATUS='Open'");
    ...
    private void initComponents() {
        ...
        jLabel39.setText("Cultural Events");
...
//                if((labEventName.getText()).equals(eventname) && (labName.getText()).equals(bookedby))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CultureEvents.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CultureEvents().setVisible(true);
            }
        });
    }
