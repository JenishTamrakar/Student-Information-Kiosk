 ...
 */
public class SportsEvents extends javax.swing.JFrame {

    /**
     * Creates new form SportsEvents
     */
    public SportsEvents() {
        initComponents();
        showDate();
    ...
    void showTable(){
            ...
            ResultSet rs = stmt.executeQuery("select EVENT_NAME, EVENT_DATE from EVENT_DETAILS where EVENT_CATEGORY='Sports' and EVENT_STATUS='Open'");
...
//                if((labEventName.getText()).equals(eventname) && (labName.getText()).equals(bookedby))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SportsEvents.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SportsEvents().setVisible(true);
            }
        });
    }
