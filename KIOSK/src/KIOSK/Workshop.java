...
public class Workshop extends javax.swing.JFrame {
    ...
    void showTable(){
            ...
            ResultSet rs = stmt.executeQuery("select EVENT_NAME, EVENT_DATE from EVENT_DETAILS where EVENT_CATEGORY='Workshop' and EVENT_STATUS='Open'");
